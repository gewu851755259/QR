...
public class AVFrame {
	...
	public static final int FRAMEINFO_SIZE = 16;
	...
	private byte streamType;      // 0 大码流; 1小码流
	private int  dataSize;   // 视频帧的大小
	private byte[] frmData = null; // Raw data of the frame.
	...
	public AVFrame(long frameNo, byte frameState, byte[] frameHead, byte[] frameData, int frameDataSize) {
		...
		frameRate = frameHead[5];
		streamType = frameHead[6];
		dataSize = Packet.byteArrayToInt_Little(frameHead, 8);
