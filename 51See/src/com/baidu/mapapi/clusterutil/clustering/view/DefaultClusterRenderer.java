...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    public static HashMap<String, ArrayList<String>> totallMap = new HashMap<String, ArrayList<String>>();
    ...
    private class CreateMarkerTask {
        ...
        private void perform(MarkerModifier markerModifier) {
            ...
            if (!shouldRenderAsCluster(cluster)) {
                for (T item : cluster.getItems()) {
                    ...
                    if (marker == null) {
                        ...
                        //娣诲姞鐨勪唬鐮� add by hx 2016 01 14
                        Bundle bundle = new Bundle();
                        MyClusterItem myItem = (MyClusterItem) item;
                        bundle.putString("name",myItem.getName());
                        bundle.putString("id",myItem.getid());
            ...
            /*add by xqe 2016 01 14*/
            String key = cluster.getPosition().latitude+","+cluster.getPosition().longitude;
            ArrayList<String> value = new ArrayList<String>();
            for(T item : cluster.getItems()){
            	MyClusterItem myItem = (MyClusterItem) item;
            	String str = myItem.getid();
            	value.add(str);
            }
            totallMap.put(key, value);
            System.out.println("count:"+cluster.getSize()+"--position:"+cluster.getPosition());
            /*end xqe 2016 01 14*/
