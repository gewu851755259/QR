...
public class BLPDetailActivity extends Activity implements OnClickListener{
	...
	public void showDetail(boolean isHide,ArrayList<String> personInfos){
		...
		Animation leftIn = (AnimationSet)AnimationUtils.loadAnimation(this, R.anim.left_in);
		Animation rightOut = (AnimationSet)AnimationUtils.loadAnimation(this, R.anim.right_out);
		if(isHide)
		{
			detailLayout.setAnimation(leftIn);
...
//			data
			...
			detailLayout.setAnimation(rightOut);
