...
public class SDRecordFolderFileListAdapter extends BaseAdapter {
	private  ArrayList<SDFileInfo> sdlist;
	private Context context;
	private OnClickListener mOnClickListener;
	
	public SDRecordFolderFileListAdapter(Context context, ArrayList<SDFileInfo> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		else
		{
			...
			if(tmp.getSzFileName().length() == 10){
				Log.i("SDRecorderFileListAda", "--文件夹item");
