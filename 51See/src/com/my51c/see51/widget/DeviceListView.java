...
/**
 * 
 * 自定义DeviceListView，继承了ListView， 但填充了listview的头部，即下拉刷新样式，并实现其功能
 * 
 * @author huangtiebing
 * 
 */
...
public class DeviceListView extends ListView implements OnScrollListener
{
	...
	private int state = DONE;// 下拉刷新中、松开刷新中、正在刷新中、完成刷新
	...
	private void init(Context context)
	{
		...
		headView = (LinearLayout) inflater.inflate(R.layout.device_list_head, null);// listview拼接headview

		arrowImageView = (ImageView) headView.findViewById(R.id.head_arrowImageView);// headview中各view
		arrowImageView.setMinimumWidth(50);
		arrowImageView.setMinimumHeight(50);
		progressBar = (ProgressBar) headView.findViewById(R.id.head_progressBar);// headview中各view
